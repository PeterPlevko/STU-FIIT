...
export class DataService {
  ...
  getAllIssues(): void {
    ...
    this.httpClient.get<Issue[]>(environment.baseUrl + '/admin/getWarCamps', { headers: headers }).subscribe(data => {
  ...
  addIssue (issue: Issue): Observable<any> {
    ...
    return this.httpClient.post<any>(
      environment.baseUrl + `/admin/addWarCamp/`, issue, { headers: headers }
    );
  }
  ...
  updateIssueBackend (issue: Issue): Observable<any> {
    ...
    return this.httpClient.put<any>(
      environment.baseUrl + `/admin/updateWarCamp/`, issue, { headers: headers }
    );
  }
  ...
  deleteIssue (id: string): Observable<any> {
    ...
    return this.httpClient.delete<any>(
      environment.baseUrl + `/admin/deleteWarCamp/${id}`, { headers: headers }
        );
  }
}
