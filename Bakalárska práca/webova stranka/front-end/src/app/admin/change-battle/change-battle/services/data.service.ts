...
export class DataService {
  ...
  getAllIssues(): void {
    ...
    this.httpClient.get<Issue[]>(environment.baseUrl + '/admin/getBattles', { headers: headers }).subscribe(data => {
  ...
  addIssue (issue: Issue): Observable<any> {
    ...
    return this.httpClient.post<any>(
      environment.baseUrl + `/admin/addBattle/`, issue, { headers: headers }
    );
  }
  ...
  updateIssueBackend (issue: Issue): Observable<any> {
    ...
    return this.httpClient.put<any>(
      environment.baseUrl + `/admin/updateBattle/`, issue, { headers: headers }
    );
  }
  ...
  deleteIssue (id: string): Observable<any> {
    ...
    return this.httpClient.delete<any>(
      environment.baseUrl + `/admin/deleteBattle/${id}`, { headers: headers }
        );
  }
