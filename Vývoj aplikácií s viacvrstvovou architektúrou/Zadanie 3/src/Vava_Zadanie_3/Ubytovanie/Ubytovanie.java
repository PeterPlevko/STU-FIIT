package Vava_Zadanie_3.Ubytovanie;
...
public class Ubytovanie implements Serializable {
        ...
        int price;
        private String izZaplatena = "Nie";


        public Ubytovanie(Customer customer, Room room, LocalDate reservationFrom, LocalDate reservationTo, int price) {
    ...
    public String getIzZaplatena() {
        return izZaplatena;
    }

    public void setIzZaplatena(String izZaplatena) {
        this.izZaplatena = izZaplatena;
    }
}
